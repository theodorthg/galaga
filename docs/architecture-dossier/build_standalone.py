#!/usr/bin/env python3
"""Builds Galaga-Architektur-Dossier.html — a single, self-contained file
...
global Godot-projects CLAUDE.md for the fuller story.
...
SRC = HERE / "index.html"
OUT = HERE / "Galaga-Architektur-Dossier.html"
